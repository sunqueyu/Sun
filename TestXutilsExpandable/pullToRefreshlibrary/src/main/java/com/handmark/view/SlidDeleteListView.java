...
public class SlidDeleteListView extends ListView
{
	...
	public SlidDeleteListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	public void setCanShowDelete(boolean canShow)
	{
		canShowDelete = canShow;
	}
